        ...
        <div class="faq-container">
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
                    <span>Apa saja keunggulan jurusan Rekayasa Perangkat Lunak?</span>
                    <span class="faq-icon">▼</span>
                </div>
                <div class="faq-answer">
                    <p>Jurusan Rekayasa Perangkat Lunak memiliki banyak keunggulan seperti prospek kerja yang luas,
                        pembelajaran teknologi terkini, kesempatan magang di perusahaan IT ternama, dan pengembangan
                        skill yang sangat dibutuhkan di era digital.</p>
                </div>
            </div>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
                    <span>Apakah jurusan Rekayasa Perangkat Lunak bisa langsung kerja</span>
                    <span class="faq-icon">▼</span>
                </div>
                <div class="faq-answer">
                    <p>Ya, lulusan RPL memiliki peluang besar untuk langsung bekerja. Banyak perusahaan mencari
                        programmer, web developer, mobile developer, dan software engineer. Dengan portfolio yang baik
                        dan skill yang mumpuni, lulusan RPL sangat diminati di industri teknologi.</p>
                </div>
            </div>
            <div class="faq-item">
                <div class="faq-question" onclick="toggleFaq(this)">
                ...
                <div class="faq-answer">
                    <p>Selain yang disebutkan sebelumnya, RPL juga memberikan kesempatan untuk freelance, membuat
                        startup sendiri, dan terus berkembang seiring perkembangan teknologi. Gaji yang kompetitif dan
                        fleksibilitas kerja juga menjadi daya tarik jurusan ini.</p>
                </div>
            </div>
        </div>
    </section>
